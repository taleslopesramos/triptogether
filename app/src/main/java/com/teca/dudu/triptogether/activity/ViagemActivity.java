        ...
        */
        ...
        listViagens.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(ViagemActivity.this)
                        ...
                        .setNegativeButton("Apagar", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                spEditor.clear();
                                spEditor.putInt(getString(R.string.ID_VIAGEM_file_key), viagemSelecionada.get_id());//salva a id_viagem ativa do usuario logado
                                spEditor.apply();
            ...
            public void onClick(View view) {
                ...
                confirmButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        int id_viagem = (int) viagemDao.salvarViagem(new Viagem(null, localViagem, nomeViagem));
                        ...
                        Intent intent = new Intent(ViagemActivity.this, AddIntegranteActivity.class);
                        startActivity(intent);
                    }
                });
